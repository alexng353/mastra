...
- Adds `braintrustLogger` as a parameter to `BraintrustExporter` allowing developers to pass in their own braintrust logger. ([#10698](https://github.com/mastra-ai/mastra/pull/10698))
